        ...
        elseif ($node instanceof Node\Expr\ArrayDimFetch)
        {
            ...
            foreach ($indexes as $index)
            {
                ...
                elseif ($index instanceof SymbolicVariable) {
                    $this->error('Creating a Symbolic Index (Not supported)'.PHP_EOL);
                }
            ...
            if ((!$create && (in_array(strval($key), $this->symbolic_parameters)))
                || (in_array(strval($key2), $this->symbolic_parameters) && (!$this->immutable_symbolic_variables && !$create))) {
